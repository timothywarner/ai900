...
def draw_bounding_boxes(image_url, objects):
    ...
    for obj in objects.objects:
        ...
        # Add object name
        draw.text([x, y-20], f"{obj.object_property} ({obj.confidence:.2f})", fill="red")
...
def demo_object_detection(image_url):
    ...
    for obj in objects.objects:
        ...
        print(f"  Position: x={obj.rectangle.x}, y={obj.rectangle.y}, w={obj.rectangle.w}, h={obj.rectangle.h}")
