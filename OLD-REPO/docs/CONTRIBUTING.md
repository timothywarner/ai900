...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/timothywarner/ai900
   ```
...
[pull requests](https://github.com/timothywarner/ai900/pulls)
...
Exam AI-900: Microsoft Azure AI Fundamentals uses [conventional commits](https://www.conventionalcommits.org), so please follow the specification.
